        ...
        <div class="rounded">
            ...
            <div>
                <div class="d-flex justify-content-between mb-3">
                    <p class="fs-5 fw-semibold"> قائمة الأيتام المكفولين في النظام </p>
                    <a href="{{route('admin.orphan.create')}}" class="submit-btn text-decoration-none">+ إضافة يتيم </a>
                </div>

                <form action="{{route('admin.orphan.SponsoredOrphan')}}" method="GET" class="search custom-sm-style w-100">
                            ...
                            <tr>
                                ...
                                <td style="position: relative;">
                                    ...
                                    <div class="action" >
                                        ...
                                        <a href="{{route('admin.orphan.sponsorship' , $orphan->id)}}" class="text-decoration-none mb-1">
                                            <img src="{{asset('images/Show.svg')}}" alt="">
                                            <span style="color: var(--text-color);">{{__(' تفاصيل الكفالة ')}}</span>
                                        </a>

                                        <a href="{{route('admin.orphan.transfer' , $orphan->id)}}" class="text-decoration-none mb-1">
