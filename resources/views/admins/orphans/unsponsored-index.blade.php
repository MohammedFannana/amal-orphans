<x-main-layout title="1000 أمل لأبناء الشهداء">
    ...
    <div class="header fw-bold" style="color: var(--primary-color);font-size:18px;  border-top-right-radius: 6px;border-top-left-radius:6px; padding:10px;background:linear-gradient(to left , #c6fdda , #edfaf1)">
        ...
        <p class="color-text fw-normal mt-2" style="font-size: 15px">
            يعرض هذا القسم الأيتام الغير مكفولين في النظام، حيث يمكنك الاطلاع على ملفاتهم الشخصية، مراجعة بياناتهم، وتحديثها عند الحاجة.  مما يسهل عملية الإشراف والإدارة بشكل شامل ومنظم.
        </p>
    </div>
        ...
        <div class="rounded">
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between mb-3">
                    <p class="fs-5 fw-semibold"> قائمة الأيتام المرشحين للكفالة  في النظام </p>
                    <a href="{{route('admin.orphan.create')}}" class="submit-btn text-decoration-none">+ إضافة يتيم </a>
                </div>

                <form action="{{route('admin.orphan.UnsponsoredOrphan')}}" method="GET" class="search custom-sm-style w-100">
                            ...
                            <tr>
                                ...
                                <td style="position: relative;">
                                    ...
                                    <div class="action" >
                                        ...
                                        <a href="{{route('admin.orphan.edit' , $orphan->id)}}" class="text-decoration-none mb-1" style="gap: 10px">
                        ...
                        @empty
                             ...
                             <tr>
                                <td colspan="7" class="text-center fs-5" style="color:var(--primary-color)">
                                    لا يوجد أيتام مرشحيين للكفالة مسجلين في النظام
                                </td>
                            </tr>
